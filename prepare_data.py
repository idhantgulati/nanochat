"""
this was added from https://github.com/qlabs-eng/slowrun
...
def preprocess(train_tokens, val_tokens, local_dir):
    ...
    # Explicitly shut down the streaming dataset's background threads before
    # Python starts finalizing, to avoid a PyGILState_Release crash on exit.
